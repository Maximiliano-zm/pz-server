SandboxVars = {
    ...
    InventoryTetris = {
        EnforceCarryWeight = false,
        EncumbranceSlow = true,
        PreventTardisStacking = true,
        UseItemTransferTime = true,
        -- Min: 1 Max: 99 Default: 3
        ItemTransferSpeedMultiplier = 3,
        -- Min: 0 Max: 8 Default: 0
        BonusGridSize = 0,
        EnableGravity = false,
        DevMode = false,
        EnableSearch = false,
        -- Min: 1 Max: 250 Default: 40
        SearchTime = 40,
        SearchBodies = 2,
        EnforceCarryWeight = false,
        EncumbranceSlow = true,
    ...
    GGSGS = {
        LootAmount = 4,
        Pre1994LootOnly = false,
        LaserAndGunLightUseBattery = true,
        ManualRack = true,
        weaponpart_wear_by_shot = true,
        -- Min: 1 Max: 1000 Default: 200
        AttachmentsLowerChance = 200,
        -- Min: 1 Max: 1000 Default: 200
        SilencersLowerChance = 200,
        weapon_random_condition = true,
        weaponpart_loot_max_condition = false,
        weaponpart_random_condition = true,
        -- Min: 0.00 Max: 100.00 Default: 10.00
        barrel_shroud_bipod = 10.0,
        -- Min: 0.00 Max: 100.00 Default: 5.00
        canon_pistol_sup = 5.0,
        -- Min: 0.00 Max: 100.00 Default: 5.00
        canon_revolver_type = 5.0,
        -- Min: 0.00 Max: 100.00 Default: 5.00
        canon_rifle_sup = 5.0,
        -- Min: 0.00 Max: 100.00 Default: 5.00
        canon_shotgun_sup = 5.0,
        -- Min: 0.00 Max: 100.00 Default: 5.00
        canon_smg_sup = 5.0,
        -- Min: 0.00 Max: 100.00 Default: 10.00
        grip = 10.0,
        -- Min: 0.00 Max: 100.00 Default: 10.00
        grip_grip_normal = 10.0,
        -- Min: 0.00 Max: 100.00 Default: 70.00
        handguard = 70.0,
        -- Min: 0.00 Max: 100.00 Default: 100.00
        handguard_ak_hg = 100.0,
        -- Min: 0.00 Max: 100.00 Default: 100.00
        handguard_ar_hg = 100.0,
        -- Min: 0.00 Max: 100.00 Default: 100.00
        handguard_svd_hg = 100.0,
        -- Min: 0.00 Max: 100.00 Default: 100.00
        handguard_win_hg = 100.0,
        -- Min: 0.00 Max: 100.00 Default: 50.00
        l_scope_ak_mount_scope = 50.0,
        -- Min: 0.00 Max: 100.00 Default: 10.00
        laser_pistol_laser = 10.0,
        -- Min: 0.00 Max: 100.00 Default: 10.00
        laser_rifle_laser = 10.0,
        -- Min: 0.00 Max: 100.00 Default: 10.00
        light_pistol_light = 10.0,
        -- Min: 0.00 Max: 100.00 Default: 10.00
        light_rifle_light = 10.0,
        -- Min: 0.00 Max: 100.00 Default: 10.00
        misc = 10.0,
        -- Min: 0.00 Max: 100.00 Default: 70.00
        mount = 70.0,
        ...
        mount_ak_mount = 50.0,
        -- Min: 0.00 Max: 100.00 Default: 50.00
        mount_rifle_mount = 50.0,
        -- Min: 0.00 Max: 100.00 Default: 50.00
        mount_shotgun_mount = 50.0,
        -- Min: 0.00 Max: 100.00 Default: 10.00
        scope_large_scope = 10.0,
        -- Min: 0.00 Max: 100.00 Default: 15.00
        scope_medium_scope = 15.0,
        -- Min: 0.00 Max: 100.00 Default: 25.00
        scope_mini_scope = 25.0,
        -- Min: 0.00 Max: 100.00 Default: 100.00
        stock_ak_type = 100.0,
        -- Min: 0.00 Max: 100.00 Default: 100.00
        stock_ar_type = 100.0,
        -- Min: 0.00 Max: 100.00 Default: 100.00
        stock_mosin_type = 100.0,
        -- Min: 0.00 Max: 100.00 Default: 5.00
        stock_pistol_type = 5.0,
        -- Min: 0.00 Max: 100.00 Default: 5.00
        stock_revolver_type = 5.0,
        -- Min: 0.00 Max: 100.00 Default: 100.00
        stock_scar_type = 100.0,
        -- Min: 0.00 Max: 100.00 Default: 100.00
        stock_shotgun_type = 100.0,
        -- Min: 0.00 Max: 100.00 Default: 100.00
        stock_svd_vss_type = 100.0,
        -- Min: 0.00 Max: 100.00 Default: 100.00
        stock_win_type = 100.0,
        -- Min: 0.00 Max: 100.00 Default: 5.00
        stool_ak_gl = 5.0,
        -- Min: 0.00 Max: 100.00 Default: 5.00
        stool_ar_gl = 5.0,
    ...
    GGSLO = {
        ...
        prob_ammo_crafts = 1.0,
        -- Min: 0.00 Max: 10.00 Default: 1.00
        prob_ammo = 1.0,
        -- Min: 0.00 Max: 10.00 Default: 1.00
        prob_ammo_mags = 1.0,
        -- Min: 0.00 Max: 10.00 Default: 1.00
        prob_repair_items = 1.0,
        -- Min: 0.00 Max: 10.00 Default: 1.00
        prob_shotguns = 1.0,
        -- Min: 0.00 Max: 10.00 Default: 1.00
        prob_autoshotguns = 1.0,
        -- Min: 0.00 Max: 10.00 Default: 1.00
        prob_attgrips = 1.0,
        -- Min: 0.00 Max: 10.00 Default: 1.00
        prob_atthanguard = 1.0,
        -- Min: 0.00 Max: 10.00 Default: 1.00
        prob_attlaser = 1.0,
        -- Min: 0.00 Max: 10.00 Default: 1.00
        prob_attlight = 1.0,
    ...
    EffortlessTowing = {
        ...
        HeavyDutyFactor = 5.0,
        -- Min: 0.00 Max: 10.00 Default: 3.00
        SportFactor = 3.0,
    },
    NepWrecks = {
    ...
    MoreItemInformation = {
        FoodLevelRequirement = true,
        WeaponLevelRequirement = true,
        MaintenanceLevelRequirement = true,
    },
    BecomeDesensitized = {
    ...
    DynamicTrading = {
        ...
        -- Min: 0.00 Max: 5.00 Default: 0.05
        RadarScanElectricityXP = 0.05,
        ...
        -- Min: 0 Max: 1000000 Default: 10000
        ColonyWealth = 10000,
        ...
        EnableBanditAmbushes = true,
        -- Min: 1 Max: 5 Default: 2
        BanditAmbushDifficulty = 2,
        -- Min: 0.00 Max: 100.00 Default: 3.00
        BanditAmbushChance = 3.0,
        -- Min: 1 Max: 100 Default: 50
        BanditRaidPartyPercent = 50,
        -- Min: 1.00 Max: 720.00 Default: 72.00
        BanditAmbushCooldownHours = 72.0,
        EnableBanditHouseRoamers = true,
        -- Min: 0.00 Max: 100.00 Default: 25.00
        BanditHouseRoamerChance = 25.0,
        -- Min: 0 Max: 100 Default: 20
        BanditHouseRoamerPopPercent = 20,
        -- Min: 0 Max: 100 Default: 50
        BanditHouseRoamerEligiblePercent = 50,
        -- Min: 0.10 Max: 24.00 Default: 0.75
        BanditHouseRoamerTravelHours = 0.75,
        -- Min: 0.50 Max: 72.00 Default: 6.00
        BanditHouseRoamerStayHours = 6.0,
        -- Min: 20 Max: 2000 Default: 80
        BanditHouseRoamerRadiusMin = 80,
        -- Min: 40 Max: 4000 Default: 220
        BanditHouseRoamerRadiusMax = 220,
    },
}
